...
function Sidebar({ points, onRemovePoint, targetLocation, onAddSearchedLocation, totalDistance, onCalculateRoute }) {
        ...
        <div className="px-6 pb-6 flex flex-col h-full overflow-hidden">
          <div className="flex justify-between items-center mb-4 md:flex-col md:items-start md:mb-8 shrink-0">
            ...
            <div className="bg-blue-50 px-3 py-1 rounded-full md:w-full md:mt-4 md:rounded-xl md:p-4 text-center">
              <span className="text-blue-600 font-bold">{(totalDistance || 0).toFixed(2)} km</span>
            </div>
          </div>
          ...
          <button 
            ...
            className="w-full bg-blue-600 text-white font-bold py-3.5 rounded-2xl shadow-lg active:scale-95 transition-all mt-auto shrink-0"
          >
            Rotayı Çiz
          </button>
        </div>
